...
try:
    ...
    with open('reports/dashboard_metrics.json', 'r') as f:
        ...
        borough_analysis = metrics_data.get("borough_analysis", {})
...
# Definición de la Función para Generar Gráficos del Dashboard 
def generate_plots():
...
def forecast():
    ...
    if request.method == 'POST':
        try:
            ...
            # Manejar las columnas categóricas 
            ...
            proba_violent = model.predict_proba(input_df)[0][1]
